...
const paths = {
  ...
  members: 'M15.5 13.2a3.6 3.6 0 100-7 3.6 3.6 0 000 7zm-1 .9c-.65-.13-1.3-.2-2-.2-3.9 0-6.5 2-6.5 4.1V20h8.6v-2.5c0-1.3.7-2.5 1.9-3.4-.6-.15-1.3-.13-2 0zM18 14c-2.8 0-4.5 1.5-4.5 3v2h7v-2c0-1.6-1.1-2.6-2.5-3z'
}
